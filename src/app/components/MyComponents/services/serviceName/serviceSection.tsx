...
export default function ServicesSection() {
  return (
    <section className="py-12 transition-colors duration-300 bg-white  ">
      ...
      <h2 className="text-3xl font-bold text-[#3E180E] mb-6 mt-6">Services</h2>
      
      </div>
      <section className="py-12 transition-colors duration-300 bg-white flex flex-col items-center ">
      <div className="container px-6">
