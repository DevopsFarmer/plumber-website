...
export default function ServicesSection() {
  return (
    <section className="py-12 transition-colors duration-300 bg-white">
      ...
      <h2 className="text-3xl font-bold text-center  text-[#3E180E] text-4xl font-bold mb-6 ">Services</h2>
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-6 inset-shadow-2xs  ">
