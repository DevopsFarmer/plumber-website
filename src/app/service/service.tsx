...
const Service: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <motion.section
        className="container pt-30 md:px-20 bg-white mx-auto text-center p-8"
      ...
      <div className="relative bg-white flex flex-wrap items-center justify-center p-8">
        <div className="relative w-full max-w-3xl">
          ...
          {/* Floating Form with Slide-Up Animation */}
          <motion.div
          ...
          >
            <div className="bg-white rounded-lg p-6 w-full sm:max-w-[400px] border-2 shadow-2xl mx-auto md:mx-0 md:absolute md:top-4/7 md:right-[-90px] md:transform -translate-y-1/7 md:-translate-y-1/2">
